...
Enter Credentials
    ...
    Run Keyword If    '${Credentials[0]}' != '#BLANK'    Input Text   ${SIGNIN_USERNAME_TEXTBOX}     ${Credentials[0]}
    Run Keyword If    '${Credentials[1]}' != '#BLANK'    Input Text    ${SIGNIN_PASSWORD_TEXTBOX}    ${Credentials[1]}
